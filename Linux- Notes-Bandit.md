...
Commands:
ssh - `ssh` is used to connect securely to a remote server.
...
ls - `ls` lists the files and directories in the current location.
...
Cat - `cat` displays the contents of a file directly in the terminal.
...
ls -la - `ls -la` displays detailed information, including hidden files and permissions.
...
cat  ./- - `cat ./-` Used when a file is named -.
...
File - `file` command identifies the type of each file
